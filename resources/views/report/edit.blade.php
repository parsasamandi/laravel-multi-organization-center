...
<div class="container-fluid mt-3 right-text">
    ...
    <form id="generalInfoEditForm" class="form-horizontal" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="form-group" align="center">
            ...
            <button type="button" id="return_button" class="btn btn-danger" data-dismiss="modal">بازگشت</button>
